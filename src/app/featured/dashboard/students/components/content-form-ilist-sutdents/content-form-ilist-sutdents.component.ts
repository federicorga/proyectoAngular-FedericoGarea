...
import { Student } from '../../interfaces/Student'; // Importa la interfaz Student
...
@Component({
  selector: 'app-content-form-list-students',
  standalone: false,
  templateUrl: './content-form-list-students.component.html',
  styleUrl: './content-form-list-students.component.scss'
})
export class ContentFormListStudentsComponent {
